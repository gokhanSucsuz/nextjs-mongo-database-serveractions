        ...
        <div className=' p-10 border max-w-lg mx-auto my-20 shadow-lg rounded-lg'>
            <form className="max-w-sm mx-auto" action={addUser}>
                ...
                <div className='flex justify-between'>
                    <button disabled={adding} onClick={handleClick} type="submit" className="text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800">Save</button>
                    <Link href="/users" className='bg-red-500 hover:bg-red-700 text-white p-2.5 rounded-md mx-2'>Cancel</Link>
                </div>
            </form>
            <div
                className={`bg-green-500 hover:bg-green-700 text-white font-bold my-4 p-2 rounded-md ${adding ? "" : "hidden"}`}> New User Saving...</div>
        </div>
